...
<g:javascript>
	...
	$(function() {
		$("#question04").buttonset();
	});
	$(function() {
		$("#question05").buttonset();
	});
	$(function() {
		$("#question06").buttonset();
	});
	$(function() {
		$("#question07").buttonset();
	});
	$(function() {
	...
	$(function() {
		$("#question13").buttonset();
	});
	$(function() {
		$("#question14").buttonset();
	});
	$(function() {
		$("#question15").buttonset();
	});
	$(function() {
		$("#question16").buttonset();
	});
	$(function() {
		$("#question17").buttonset();
	});
	$(function() {
		$("#question18").buttonset();
	});
	$(function() {
		$("#question19").buttonset();
	});
	$(function() {
		$("#question20").buttonset();
	});
	$(function() {
		$("#question21").buttonset();
	});
	$(function() {
  ...
  <div id="formholder" style="margin-right: 45%;">
	...
	<g:form name="form02" method="post">
	  <h3>No elite should interfere with self-organizing and voluntary groups, communities, and organizations
		...
		<div id="question02">
			<input type="radio" id="radio005" name="radio" checked="checked"><label for="radio005">Strongly Disagree</label>
			<input type="radio" id="radio006" name="radio"><label for="radio006">Disagree</label>
	...
	<g:form name="form03" method="post">
	  <h3>Security is the most important societal value, and therefore other values ought to be sacrificed to preserve security
		...
		<div id="question03">
			<input type="radio" id="radio009" name="radio" checked="checked"><label for="radio009">Strongly Disagree</label>
			<input type="radio" id="radio010" name="radio"><label for="radio010">Disagree</label>
	...
	<g:form name="form04" method="post">
	  <h3>Questioning or challenging leaders in an organization or institution should be forbidden
		...
		<div id="question04">
			<input type="radio" id="radio013" name="radio" checked="checked"><label for="radio013">Strongly Disagree</label>
			<input type="radio" id="radio014" name="radio"><label for="radio014">Disagree</label>
	...
	<g:form name="form05" method="post">
	  <h3>Wealthy individuals should have few or no restrictions on gaining more assets
		...
		<div id="question05">
			<input type="radio" id="radio017" name="radio" checked="checked"><label for="radio017">Strongly Disagree</label>
			<input type="radio" id="radio018" name="radio"><label for="radio018">Disagree</label>
	...
	<g:form name="form06" method="post">
	  <h3>Value should be communicated as prices arising from competition through exchange-based markets
		...
		<div id="question06">
			<input type="radio" id="radio021" name="radio" checked="checked"><label for="radio021">Strongly Disagree</label>
			<input type="radio" id="radio022" name="radio"><label for="radio022">Disagree</label>
	...
	<g:form name="form07" method="post">
	  <h3>Traditional social organizations and institutions should be preserved
		...
		<div id="question07">
			<input type="radio" id="radio025" name="radio" checked="checked"><label for="radio025">Strongly Disagree</label>
			<input type="radio" id="radio026" name="radio"><label for="radio026">Disagree</label>
	...
	<g:form name="form08" method="post">
	  <h3>Maintaining the status quo ensures a stable society
		...
		<div id="question08">
			<input type="radio" id="radio029" name="radio" checked="checked"><label for="radio029">Strongly Disagree</label>
			<input type="radio" id="radio030" name="radio"><label for="radio030">Disagree</label>
	...
	<g:form name="form09" method="post">
	  <h3>Power, people, and things should be redistributed away from central locations
		...
		<div id="question09">
			<input type="radio" id="radio033" name="radio" checked="checked"><label for="radio033">Strongly Disagree</label>
			<input type="radio" id="radio034" name="radio"><label for="radio034">Disagree</label>
	...
	<g:form name="form10" method="post">
	  <h3>Utilization of resources and decisions on local improvements is a job for those entities closest to the problem at hand
		...
		<div id="question10">
			<input type="radio" id="radio037" name="radio" checked="checked"><label for="radio037">Strongly Disagree</label>
			<input type="radio" id="radio038" name="radio"><label for="radio038">Disagree</label>
	...
	<g:form name="form11" method="post">
	  <h3>Biodiversity should be preserved as much as possible for future generations
		...
		<div id="question11">
			<input type="radio" id="radio041" name="radio" checked="checked"><label for="radio041">Strongly Disagree</label>
			<input type="radio" id="radio042" name="radio"><label for="radio042">Disagree</label>
	...
	<g:form name="form12" method="post">
	  <h3>Natural systems should be preserved for their own sake, rather than merely for human uses
		...
		<div id="question12">
			<input type="radio" id="radio045" name="radio" checked="checked"><label for="radio045">Strongly Disagree</label>
			<input type="radio" id="radio046" name="radio"><label for="radio046">Disagree</label>
	...
	<g:form name="form13" method="post">
	  <h3>All persons have the same intrinsic worth, and rules that do not reflect fair treatment should be changed
		...
		<div id="question13">
			<input type="radio" id="radio049" name="radio" checked="checked"><label for="radio049">Strongly Disagree</label>
			<input type="radio" id="radio050" name="radio"><label for="radio050">Disagree</label>
	...
	<g:form name="form14" method="post">
	  <h3>Group decision making and teamwork limits the likelihood of oppression and coercion
		...
		<div id="question14">
			<input type="radio" id="radio053" name="radio" checked="checked"><label for="radio053">Strongly Disagree</label>
			<input type="radio" id="radio054" name="radio"><label for="radio054">Disagree</label>
	...
	<g:form name="form15" method="post">
	  <h3>Preserving an orthodox culture is of the utmost importance
		...
		<div id="question15">
			<input type="radio" id="radio057" name="radio" checked="checked"><label for="radio057">Strongly Disagree</label>
			<input type="radio" id="radio058" name="radio"><label for="radio058">Disagree</label>
	...
	<g:form name="form16" method="post">
	  <h3>Beliefs can only be allowed to change if they do not conflict with foundational principles
		...
		<div id="question16">
			<input type="radio" id="radio061" name="radio" checked="checked"><label for="radio061">Strongly Disagree</label>
			<input type="radio" id="radio062" name="radio"><label for="radio062">Disagree</label>
	...
	<g:form name="form17" method="post">
	  <h3>Attaining the goal of a free society is worth the challenge of changing rules
		...
		<div id="question17">
			<input type="radio" id="radio065" name="radio" checked="checked"><label for="radio065">Strongly Disagree</label>
			<input type="radio" id="radio066" name="radio"><label for="radio066">Disagree</label>
	...
	<g:form name="form18" method="post">
	  <h3>As liberties and civil rights are made into laws, they are to be protected and enhanced
		...
		<div id="question18">
			<input type="radio" id="radio069" name="radio" checked="checked"><label for="radio069">Strongly Disagree</label>
			<input type="radio" id="radio070" name="radio"><label for="radio070">Disagree</label>
	...
	<g:form name="form19" method="post">
	  <h3>Fast societal changes are useful and necessary for society to reach its full potential
		...
		<div id="question19">
			<input type="radio" id="radio073" name="radio" checked="checked"><label for="radio073">Strongly Disagree</label>
			<input type="radio" id="radio074" name="radio"><label for="radio074">Disagree</label>
	...
	<g:form name="form20" method="post">
	  <h3>For society to change quickly, value systems need to be thoroughly and rapidly modified
		...
		<div id="question20">
			<input type="radio" id="radio077" name="radio" checked="checked"><label for="radio077">Strongly Disagree</label>
			<input type="radio" id="radio078" name="radio"><label for="radio078">Disagree</label>
	...
	<g:form name="form21" method="post">
	  <h3>Individual differences in experience and perception cause people to have different values
		...
		<div id="question21">
			<input type="radio" id="radio081" name="radio" checked="checked"><label for="radio081">Strongly Disagree</label>
			<input type="radio" id="radio082" name="radio"><label for="radio082">Disagree</label>
	...
	<g:form name="form22" method="post">
	  <h3>No action or belief is absolutely good or bad
		...
		<div id="question22">
			<input type="radio" id="radio085" name="radio" checked="checked"><label for="radio085">Strongly Disagree</label>
			<input type="radio" id="radio086" name="radio"><label for="radio086">Disagree</label>
	...
	<g:form name="form23" method="post">
	  <h3>Getting and managing resources should be done by groups and organizations rather than an elite
		...
		<div id="question23">
			<input type="radio" id="radio089" name="radio" checked="checked"><label for="radio089">Strongly Disagree</label>
			<input type="radio" id="radio090" name="radio"><label for="radio090">Disagree</label>
	...
	<g:form name="form24" method="post">
	  <h3>Management of organizations and resources requires cooperation between multiple entities to ensure public benefit
		...
		<div id="question24">
			<input type="radio" id="radio093" name="radio" checked="checked"><label for="radio093">Strongly Disagree</label>
			<input type="radio" id="radio094" name="radio"><label for="radio094">Disagree</label>
	...
	<g:form name="form25" method="post">
	  <h3>Some in society should have more privileges and rights than others
		...
		<div id="question25">
			<input type="radio" id="radio097" name="radio" checked="checked"><label for="radio097">Strongly Disagree</label>
			<input type="radio" id="radio098" name="radio"><label for="radio098">Disagree</label>
	...
	<g:form name="form26" method="post">
	  <h3>It is acceptable for one group to dominate other groups
		...
		<div id="question26">
			<input type="radio" id="radio101" name="radio" checked="checked"><label for="radio101">Strongly Disagree</label>
			<input type="radio" id="radio102" name="radio"><label for="radio102">Disagree</label>

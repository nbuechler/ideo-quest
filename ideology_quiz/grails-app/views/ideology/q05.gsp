...
<body>
  ...
  <div id="formholder" style="margin-right: 45%;">
	<g:form name="form05" action="q06" method="post">
	<div>${radio04}</div>
			<h3>Wealthy individuals should have few or no restrictions on
				gaining more assets</h3>
			<div id="question05" class="ataQuestion">

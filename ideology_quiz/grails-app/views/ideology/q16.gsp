...
<body>
  ...
  <div id="formholder" >
	<g:form name="form16" action="q17" method="post">
	<div>${radio15}</div>
	  <h3>New ideas can not conflict with the foundational idea of a group
</h3>
		<div id="question16"  class="ataQuestion">
